...
public class ManejadorArbol {
    ...
    public void insertar(Nodo nuevo, Nodo pivote) {
        if (this.raiz == null) {
            ...
            if (nuevo.getDato().compareTo(nuevo.toString()) <= pivote.getDato().compareTo(pivote.toString())) {
    ...
    public boolean existe(String dato) {
        Nodo aux = raiz;
        while (aux != null) {
            if (dato.compareTo(dato.toString()) == aux.getDato().compareTo(dato.toString())) {
                return true;
            } else if (dato.compareTo(dato.toString()) > aux.getDato().compareTo(dato.toString())) {
                aux = aux.getDer();
            } else {
                aux = aux.getIzq();
            }
